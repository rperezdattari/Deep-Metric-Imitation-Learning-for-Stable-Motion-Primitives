...
class Params:
    ...
    results_path: str = 'results/1st_order_2D_condor_rbf/'
    ...
    adaptive_gains: bool = False  # adaptive gains if true
    ...
    stabilization_loss_weight: float = 0.25  # 0.93  # stability loss weight
